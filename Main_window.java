...
public class Main_window extends JFrame implements ActionListener{
    ...
    public Main_window(){
        ...
        try {                        
            ...
            avgW=new JLabel("Sredni wiek pojazdu: ");
            avgP=new JLabel("Sredni przebieg pojazdu: ");
            maxW=new JLabel("Najstarszy pojazd : ");
            maxP=new JLabel("Najwiekszy przebieg pojazdu: ");
            avgSpK=new JLabel("Srednio pojazdow na kierowce: ");
        }
